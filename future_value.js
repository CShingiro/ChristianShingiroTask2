...
for (let i = 1; i <= months; i++ ) {
    futureMonthlyValue = futureMonthlyValue + (futureMonthlyValue*rate/12/100);
}

// display results
document.write(`<p><strong>Future Value with Yearly Interest</strong></p>`);
...
document.write(`<p><strong>Future Value with Monthly Interest</strong></p>`);
document.write(`<p><label>Investment amount:</label> ${investment}</p>`);
document.write(`<p><label>Interest rate:</label> ${rate}</p>`);
document.write(`<p><label>Years:</label> ${years}</p>`);
